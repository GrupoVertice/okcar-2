...
const logomobile = document.getElementById("logo-change")
...
const toggleDropdown = function () {
  ...
  logomobile.classList.toggle("show");
...
wrapper.forEach(element => {
  ...
  element.addEventListener("mousemove", ele => {
    const card = element.querySelector(".card_");
    ...
    const angleX = (state.mouseX / state.width) * 5;
    const angleY = (state.mouseY / state.height) * -5;
...
//tabs container
const tabs = document.querySelectorAll("#tabs-container .tab_");
